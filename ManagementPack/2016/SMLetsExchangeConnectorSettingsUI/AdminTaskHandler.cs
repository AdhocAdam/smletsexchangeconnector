    ...
    internal class AdminTaskHandler : ConsoleCommand
    {
        ...
        public override void ExecuteCommand(IList<NavigationModelNodeBase> nodes, NavigationModelNodeTask task, ICollection<string> parameters)
        {
            ...
            */
            ...
            wizard.WizardWindowTitle = "SMLets Exchange Connector Settings v1.4.3";
            ...
            wizard.AddLast(new WizardStep("DLLs", typeof(DLLForm), wizard.WizardData));
            ...
            wizard.AddLast(new WizardStep("Azure Cognitive Services", typeof(AzureCognitiveServices), wizard.WizardData));
