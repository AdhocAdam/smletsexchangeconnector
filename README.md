...
- The connector can now be enabled to process the members of a group to vote on behalf of a Review Activity. Users voting on behalf of groups in Review Activities will have their user account marked as the "Voted By" and their comment appeneded to the vote.
